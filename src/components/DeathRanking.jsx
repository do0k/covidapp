...
function DeathRanking(props) {
	const [resultData, setResultData] = useState([])
	
	useEffect(() => {
		fetch('https://do0kcovid19api.herokuapp.com/ranking/deaths').then(res => res.json())
	...
	return (
			<div id='death'>
				...
				<div className="row">
					<div className="card">
						<h4 className="card-title">لیست کشورهای جهان به ترتیب تعداد افراد متوفی</h4>
