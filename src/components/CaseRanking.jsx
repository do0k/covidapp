...
function CaseRanking(props) {
	const [resultData, setResultData] = useState([])
	
	useEffect(() => {
		fetch('https://do0kcovid19api.herokuapp.com/ranking/cases').then(res => res.json())
	...
	return (
			<div id='case'>
				...
				<div className="row">
					<div className="card">
						<h4 className="card-title">لیست کشورهای جهان به ترتیب تعداد افراد بیمار</h4>
